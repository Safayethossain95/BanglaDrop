...
import { ShoppingBag, Search, User, ArrowRight, Truck, ShieldCheck, Headset, CreditCard, CheckCircle } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center gap-3">
              ...
              <span className="text-2xl font-bold tracking-tight text-slate-900">EcoStore</span>
            </div>
            ...
            <div className="flex items-center gap-5 text-slate-600">
              ...
              <button className="hover:text-slate-900 transition-colors"><User className="w-5 h-5" /></button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-8 h-8 bg-white text-slate-900 rounded-lg flex items-center justify-center font-bold text-lg">
                  E
                </div>
                <span className="text-xl font-bold tracking-tight text-white">EcoStore</span>
              </div>
